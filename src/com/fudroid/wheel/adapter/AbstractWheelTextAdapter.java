package com.fudroid.wheel.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	public static final int DEFAULT_SELECTED_TEXT_COLOR = 0xFF000000;
	...
	private int textSelectedColor = DEFAULT_SELECTED_TEXT_COLOR;
	private int textSelectedSize = DEFAULT_SELECTED_TEXT_SIZE;
	...
	protected void configureTextView(TextView view, int index) {
		if (currentItem != -1 && currentItem == index) {
			view.setTextColor(textSelectedColor);
			view.setTextSize(textSelectedSize);
		} else {
